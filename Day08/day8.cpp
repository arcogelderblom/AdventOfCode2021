...
int count1478DigitsInOutputValue(std::vector<std::string> notesAndOutput)
{
    ...
    {
        std::vector<std::string> notesAndOutputVector = StringOperations::splitString(item, " | ");
        std::vector<std::string> notes = StringOperations::splitString(notesAndOutputVector[0], " ");
        std::vector<std::string> output = StringOperations::splitString(notesAndOutputVector[1], " ");
...
int decodeOutput(std::string notesAndOutput)
{
    ...
    std::vector<std::string> notesAndOutputVector = StringOperations::splitString(notesAndOutput, " | ");
    std::vector<std::string> notes = StringOperations::splitString(notesAndOutputVector[0], " ");
    std::vector<std::string> output = StringOperations::splitString(notesAndOutputVector[1], " ");
