...
unsigned long getResult(std::string startPolymerTemplate, std::vector<std::string> pairInsertionRules, int amountOfSteps)
{
    ...
    {
        std::vector<std::string> pairAndInsertionRule = StringOperations::splitString(pairInsertionRule, " -> ");
...
int main(void)
{
    ...
    std::string testPolymerTemplate = StringOperations::splitString(testInput, "\n\n")[0];
    std::vector<std::string> testPairInsertionRules = StringOperations::splitString(StringOperations::splitString(testInput, "\n\n")[1], "\n");
