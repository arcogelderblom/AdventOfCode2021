...
Cube::Cube(std::string bounds, bool on):
    on(on)
{
    std::string xStartAndEnd = StringOperations::splitString(bounds, ",")[0].substr(2);
    std::string yStartAndEnd = StringOperations::splitString(bounds, ",")[1].substr(2);
    std::string zStartAndEnd = StringOperations::splitString(bounds, ",")[2].substr(2);
    xMin = std::stoi(StringOperations::splitString(xStartAndEnd, "..")[0]);
    xMax = std::stoi(StringOperations::splitString(xStartAndEnd, "..")[1]);
    yMin = std::stoi(StringOperations::splitString(yStartAndEnd, "..")[0]);
    yMax = std::stoi(StringOperations::splitString(yStartAndEnd, "..")[1]);
    zMin = std::stoi(StringOperations::splitString(zStartAndEnd, "..")[0]);
    zMax = std::stoi(StringOperations::splitString(zStartAndEnd, "..")[1]);
}
