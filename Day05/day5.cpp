...
std::vector<LinePoint> toLinePoint(std::vector<std::string> linePoints) 
{
    ...
    {
        std::vector<std::string> startAndEnd = StringOperations::splitString(linePointString, " -> ");
        std::vector<std::string> startString = StringOperations::splitString(startAndEnd[0], ",");
        std::vector<std::string> endString = StringOperations::splitString(startAndEnd[1], ",");
