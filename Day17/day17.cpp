...
std::vector<Coordinate> getTargetAreaBounds(std::string targetAreaString)
{
    ...
    std::vector<std::string> targetAreaSplitted = StringOperations::splitString(targetAreaString, " ");
    std::vector<std::string> xStartAndEnd = StringOperations::splitString(targetAreaSplitted[2].substr(2), "..");
    std::vector<std::string> yStartAndEnd = StringOperations::splitString(targetAreaSplitted[3].substr(2), "..");
