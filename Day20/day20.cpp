...
int main(void)
{
    std::vector<std::string> testInput = StringOperations::splitString("..#.#..#####.#.#.#.###.##.....###.##.#..###.####..#####..#....#..#..##..###..######.###...####..#..#####..##..#.#####...##.#.#..#.##..#.#......#.###.######.###.####...#.##.##..#..#..#####.....#.#....###..#.##......#.....#..#..#..##..#...##.######.####.####.#.#...#.......#..#.#.#...####.##.#......#..#...##.#.##..#...##.#.##..###.#......#.#.......#.#.#.####.###.##...#.....####.#..#..#.##.#....##..#.####....##...##..#...#......#.#.......#.......##..####..#...#.#.#...##..#.#..###..#####........#..####......#..#\n\n#..#.\n#....\n##..#\n..#..\n..###", "\n\n");
	std::string testImageEnhancementAlgorithm = testInput[0];
	std::vector<std::string> testImage = StringOperations::splitString(testInput[1], "\n");
    assert(getLitPixelsAfterEnhancing(testImage, testImageEnhancementAlgorithm, 2) == 35);
    
    InputFile inputFile("InputFiles/day20.txt");
    std::vector<std::string> input = inputFile.getContentAsString("\n\n");
	std::string imageEnhancementAlgorithm = input[0];
	std::vector<std::string> image = StringOperations::splitString(input[1], "\n");
